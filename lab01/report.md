...
![Параметры установки](image/04.png){ #fig:007 width=70% height=70% }
 
Перехожу к этапу установки и дожидаюсь его завершения.

![Этап установки](image/05.png){ #fig:008 width=70% height=70% }

![Завершение установки](image/06.png){ #fig:009 width=70% height=70% }
